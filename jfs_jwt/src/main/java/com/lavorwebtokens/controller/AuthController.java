...
import com.lavorwebtokens.controller.dto.LoginDto;
import com.lavorwebtokens.controller.dto.Token;
...
public class AuthController {
            ...
            throws ServletException
    {
        ...
        {
            return new Token( generateToken( loginDto.getUsername() ), accessToken1);
        }
